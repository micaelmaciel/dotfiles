...
vim.keymap.set("n", "E", "<cmd>w<CR><cmd>e<CR>")
...
vim.keymap.set("n", "gF", "ggVG=<C-O>") -- format whole file
...
require("lazy").setup({
  ...
  -- COLORSCHEMES
  {
    ...
    lazy = true, -- we can lazy load this since it isn't the startup theme
    opts = {
      styles = {
  ...
  -- Plugin 2: PaperColor (Active)
  {
    "NLKNguyen/papercolor-theme",
    priority = 1000,
    config = function()
      -- This function runs when papercolor-theme is loaded
